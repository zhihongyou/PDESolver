...
int main() {
    ...
    Qxx.setRhsTerms({
        {-1, { {&incompFlow.vx}, {"d1x",&Qxx} }},
        {-1,{ {&incompFlow.vy}, {"d1y",&Qxx} }},
        {lambda, { {"d1x",&incompFlow.vx}, {&phi} }},
        {-1, { {"d1x",&incompFlow.vy}, {&Qxy}, {&phi} }},
        {{ {"d1y",&incompFlow.vx},{&Qxy} }},        
        {-GammaQ*aQ,{{&Qxx}, {&phi}}},
    ...
    Qxy.setRhsTerms({
        {-1, { {&incompFlow.vx}, {"d1x",&Qxy} }},
        {-1,{ {&incompFlow.vy}, {"d1y",&Qxy} }},
        {0.5*lambda, { {"d1x",&incompFlow.vy}, {&phi} }},
        {0.5*lambda, { {"d1y",&incompFlow.vx}, {&phi} }},
        {{ {"d1x",&incompFlow.vy},{&Qxx} }},
        {-1, { {"d1y",&incompFlow.vx},{&Qxx} }},        
        {-GammaQ*aQ,{{&Qxy}, {&phi} }},
    ...
    phi.setRhsTerms({
        {-1, { {&incompFlow.vx}, {"d1x",&phi} }},
        {-1,{ {&incompFlow.vy}, {"d1y",&phi} }},
        {GammaPhi,{{"laplace",&mu}}},
        {gPhi, {{&phi}}}
    });
    ...
    // Creating an evolver:    
    Evolver evolver(&mySys,t0,T,dt,dtExpo,device,timeScheme,FDMScheme);
