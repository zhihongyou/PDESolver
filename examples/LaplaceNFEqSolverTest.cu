...
int main() {
    ...
    cout << LaplNFEqSolver.max_power <<endl;
    cout << LaplNFEqSolver.prefactors[0] <<", "<< LaplNFEqSolver.prefactors[1] <<endl;
    double prefactors_t[2]={2,10};
    LaplNFEqSolver.setLaplaceNFEqSolver(1, prefactors_t);
    cout << LaplNFEqSolver.max_power <<endl;
    cout << LaplNFEqSolver.prefactors[0] <<", "<< LaplNFEqSolver.prefactors[1] <<endl;
    ...
    LaplNFEqSolver.solveLaplaceNFEq(phi.f[0],f.f[0]);
