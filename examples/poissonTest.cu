...
int main() {
    ...
    // Running simulations
    evolver.run();
    phi.export_conf_any(phi.rhs[0], "phi_rhs", "0", "gpu", 1);
    phi.export_conf_any(phi.rhs[1], "phi_rhs", "1", "gpu", 1);
    phi.export_conf_any(phi.rhs[2], "phi_rhs", "2", "gpu", 1);
    phi.export_conf_any(phi.rhs[3], "phi_rhs", "3", "gpu", 1);
